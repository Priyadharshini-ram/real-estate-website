...
const Rent = () => {
  ...
  const [properties, setProperties] = useState([
    { id: 1, title: "Luxury Villa", rent: "$2,500/month", location: "New York", image: "villa.jpg", video: "villa.mp4", lat: 40.7128, lng: -74.0060 },
    { id: 2, title: "Modern Apartment", rent: "$1,800/month", location: "Los Angeles", image: "apartment.jpg", video: "apartment.mp4", lat: 34.0522, lng: -118.2437 },
    { id: 3, title: "Cozy Cottage", rent: "$1,200/month", location: "Texas", image: "cottage.jpg", video: "cottage.mp4", lat: 31.9686, lng: -99.9018 }
  ]);
